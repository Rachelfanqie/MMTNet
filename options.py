...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--dataset', type=str, default ='Our1')
        parser.add_argument('--pretrain_weights',type=str, default='./log/MMTNet/model_best.pth', help='path of pretrained_weights')
        ...
        parser.add_argument('--arch', type=str, default ='MMTNet_B',  help='archtechture')
        ...
        parser.add_argument('--env', type=str, default ='_0706',  help='env')  # _
        parser.add_argument('--checkpoint', type=int, default=500, help='checkpoint')  # 50
        ...
        parser.add_argument('--train_dir', type=str, default ='./Pytorch_Program/MMTNet/datasets/deblurring/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='./Pytorch_Program/MMTNet/datasets/deblurring/test',  help='dir of train data')
