...
parser = argparse.ArgumentParser(description='Image motion deblurring evaluation on Our')
parser.add_argument('--input_dir', default='./MMTNet/datasets/deblurring/MTRBlur/test/',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./MMTNet/results/deblurring/Our/test_gopro_o/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='./MMTNet/train/logs/model_best.pth',
    type=str, help='Path to weights')
parser.add_argument('--gpus', default='0', type=str, help='CUDA_VISIBLE_DEVICES')
parser.add_argument('--arch', default='MMTNet_B', type=str, help='arch')
...
with torch.no_grad():
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        ssim = ssim_loss(rgb_restored, rgb_gt, multichannel=True, win_size =3, data_range= 1.0)
